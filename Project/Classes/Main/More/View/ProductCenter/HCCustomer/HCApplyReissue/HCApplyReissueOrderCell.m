...
@interface HCApplyReissueOrderCell ()
/**
 *订单编号
 */
...
@implementation HCApplyReissueOrderCell
...
-(void)setInfo:(HCProductIntroductionInfo *)info
{
    ...
    _orderGoodsNameLab.text = @"订购商品: M-Talk二维码";
    ...
    [builder addRecord:@[
                         ...
                         [NSString stringWithFormat:@"%d",self.info.labelPrice],
                         @""]];
