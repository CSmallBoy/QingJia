//
//  HCMyPromisedNotifiMessageCell.m
//  钦家
//
...
@interface HCMyPromisedNotifiMessageCell()<UIGestureRecognizerDelegate>
...
-(void)tap:(UITapGestureRecognizer *)tap
{
    ...
    {
        NSDictionary *dic = @{@"info" : self.info.callId,@"status":self.info.status};
