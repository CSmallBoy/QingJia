...
{
    if (!_userNameLab) {
        _userNameLab = [[UILabel alloc]initWithFrame:CGRectMake(10, 0, 120, 30)];
...
-(UILabel *)notificationMessageLab
{
    if (!_notificationMessageLab) {
        _notificationMessageLab = [[UILabel alloc]initWithFrame:CGRectMake(10,30 , SCREEN_WIDTH-40, 30)];
        ...
        _notificationMessageLab.font = [UIFont systemFontOfSize:14];
    }
