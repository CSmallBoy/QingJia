...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (indexPath.section == 1 && indexPath.row == 0)
    {
        ...
        HCReceiveAddressController *receivedVC = [[HCReceiveAddressController alloc]init];
...
- (UIView *)tableHeaderView
{
    if(!_tableHeaderView){
        ...
        UILabel *mylabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2-20,20, 40, 40)];
        mylabel.text = @"我的";
        ...
        [backButton setBackgroundImage:IMG(@"barItem-back") forState:UIControlStateNormal];
        ...
        [_tableHeaderView addSubview:mylabel];
        [_tableHeaderView addSubview:backButton];
    }
