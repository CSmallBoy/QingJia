...
@interface HCMtalkMyOrderListController ()

@end

@implementation HCMtalkMyOrderListController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        HCMtalkMyOrderFinisheController *finshedVC = [[HCMtalkMyOrderFinisheController alloc]init];
        [self.navigationController pushViewController:finshedVC animated:YES];
    }
}
