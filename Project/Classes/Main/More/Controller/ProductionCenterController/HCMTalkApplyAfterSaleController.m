...
@interface HCMTalkApplyAfterSaleController () <UITableViewDataSource,UITableViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIActionSheetDelegate>
{
    NSInteger num1;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        {
            UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(10+60*i, 40, 50, 50)];
        ...
        if (self.images.count< 3)
        {
            ...
            button.frame = CGRectMake(10+60*self.images.count, 40, 50, 50);
...
-(void)choosePhoto
{
    ...
    UIActionSheet  *sheet = [[UIActionSheet alloc]initWithTitle:@"上传照片" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"拍照",@"相册选取", nil];
