...
-(UISegmentedControl *)segmented
{
        if (!_segmented)
        {
            ...
            _segmented.frame = CGRectMake(20, 64, SCREEN_WIDTH-40, 30);
...
-(HCUnReadNotificationViewController *)unreadVC
{
    if (!_unreadVC) {
        ...
        _unreadVC.view.frame = CGRectMake(10, 94, SCREEN_WIDTH-20, SCREEN_HEIGHT);
...
-(HCReadNotificationViewController *)readVC
{
    if (!_readVC) {
        ...
        _readVC.view.frame = CGRectMake(10, 94, SCREEN_WIDTH-20, SCREEN_HEIGHT);
...
-(HCFollowNotificationViewController *)followVC
{
    if (!_followVC) {
        ...
        _followVC.view.frame = CGRectMake(10, 94, SCREEN_WIDTH-20, SCREEN_HEIGHT);
