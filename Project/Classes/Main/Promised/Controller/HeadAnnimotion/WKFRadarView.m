...
-(void)drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < pulsingCount; i++) {
        ...
        pulsingLayer.backgroundColor = [UIColor colorWithRed:222/255.0 green:35/255.0 blue:46/255.0 alpha:1.0].CGColor;
        pulsingLayer.borderColor = [UIColor colorWithRed:222/255.0 green:35/255.0 blue:46/255.0 alpha:1.0].CGColor;
    ...
    CGRect thumbnailRect = CGRectMake(0, 0, 90, 90);
    ...
    thumbnailLayer.cornerRadius = 45;
